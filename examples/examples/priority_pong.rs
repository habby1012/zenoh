...
fn main() {
    ...
    let (config, express, priority) = parse_args();
...
struct Args {
    ...
    /// Set priority level (1=RealTime, 2=InteractiveHigh, 3=InteractiveLow, 4=DataHigh, 5=Data, 6=DataLow, 7=Background)
...
fn parse_args() -> (Config, bool, Priority) {
    let args = Args::parse();
    ...
    (args.common.into(), !args.no_express, priority)
}

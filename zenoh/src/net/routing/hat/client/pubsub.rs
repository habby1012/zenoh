...
fn register_simple_subscription(
    ...
    println!("[client!!] register_simple_subscription");
...
fn propagate_forget_simple_subscription(
    ...
    println!("[client!!] propagate_forget_simple_subscription");
...
pub(super) fn undeclare_simple_subscription(
    ...
    println!("[client!!] undeclare_simple_subscription");
...
fn forget_simple_subscription(
    ...
    println!("[client!!] forget_simple_subscription");
...
pub(super) fn pubsub_new_face(
    ...
    println!("[client!!] pubsub_new_face");
...
impl HatPubSubTrait for HatCode {
    ...
    fn compute_data_route(
        ...
        let key_expr = match OwnedKeyExpr::try_from(key_expr) {
            Ok(ke) => ke,
            Err(e) => {
                println!("[client!! warn] Invalid KE reached the system: {}", e);
                return Arc::new(route);
            }
        };
    ...
    fn get_data_routes_entries(&self, _tables: &Tables) -> RoutesIndexes {
        println!("[client!!] get_data_routes_entries");
        get_routes_entries()
    }
    ...
    fn get_matching_subscriptions(
        ...
        println!("[client!!] get_matching_subscriptions");
        let mut matching_subscriptions = HashMap::new();
        if key_expr.ends_with('/') {
            return matching_subscriptions;
        }
        println!("[client!!] get_matching_subscriptions({})", key_expr,);
